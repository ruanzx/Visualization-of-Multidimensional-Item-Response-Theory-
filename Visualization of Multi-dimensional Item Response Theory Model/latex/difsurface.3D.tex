\HeaderA{difsurface.3D}{Function to plot the three-dimensional score difference surface}{difsurface.3D}
\keyword{MIRT}{difsurface.3D}
\keyword{Surface difference}{difsurface.3D}
